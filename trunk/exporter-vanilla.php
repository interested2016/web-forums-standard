...
?>
	...
	<h2><?php _e ('Export') ?></h2>
	<p><?php _e ('When you submit the form below, Vanilla will generate a BBXF file for you to save to your computer.'); ?></p>
	<p><?php _e ('This file will contain data about your users, forums, topics, and posts.  You can use the Import function of another Vanilla installation or another compatible web forums software to import this data.'); ?></p>
