...
/**
 * Web Forum Export/Import Standard Parser Class
 *
 * This class contains functions which facilitate parsing of the XML
 * standard developed for web forums data.  These functions natively
...
class WF_Parse
{
	...
	function call_element ($item)
	{
		...
		return call_user_func (array ('WF_Parse', $function), $item[1]);
	}
