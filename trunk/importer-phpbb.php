...
function import_init ()
{
	if (!class_exists ('BBXF_Parse'))
	{
		...
		require_once ('importer/bbip-phpbb.php');
	}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>phpBB3 BBXF Importer</title>
	</head>
	<body>

	<h2>Import</h2>
	<?php if ('true' == $_POST['importing']) : import_main (); else : ?>
	<p>phpBB can import forums data from a BBXF file you provide via the form below.  Such a file can be generated by another phpBB installation or another forum software with a compatible export feature.</p>
